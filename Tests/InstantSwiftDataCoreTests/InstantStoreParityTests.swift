...
struct InstantStoreParityTests {
  ...
  func parityCoverageReportRecordsCurrentSourceProvenance() throws {
    ...
    expectNoDifference(report.recordCount, 294)
    expectNoDifference(report.exactCount, 28)
    expectNoDifference(report.adaptedCount, 262)
    ...
    #expect(report.sourceFiles.contains("upstream/instant/client/packages/core/__tests__/src/auth-extra-fields.e2e.test.ts"))
    ...
    #expect(report.sourceFiles.contains("upstream/instant/client/packages/python/tests/test_subscription_state.py"))
    #expect(report.sourceFiles.contains("upstream/instant/client/packages/python/tests/test_streams_state.py"))
    ...
    #expect(report.records.contains { $0.id == "instant.infinite-query.typed-client-adapter" && $0.status == .adapted })
    ...
    #expect(report.records.contains { $0.id == "instant.auth-extra-fields.magic-code" && $0.status == .adapted })
    ...
    #expect(report.records.contains { $0.id == "sqlite.draft.relation-ref-save" && $0.status == .adapted })
    ...
    #expect(report.records.contains { $0.id == "sqlite.cloudkit-demo.remote-share" && $0.status == .adapted })
