...
extension InstantStoreTests {
  ...
  func cliValidationParityReportEmitsCoverageProvenance() throws {
    ...
    expectNoDifference(jsonOutput.recordCount, 292)
    expectNoDifference(jsonOutput.exactCount, 28)
    expectNoDifference(jsonOutput.adaptedCount, 260)
    ...
    #expect(humanOutput.contains("records: 292"))
    #expect(humanOutput.contains("exact: 28"))
    #expect(humanOutput.contains("adapted: 260"))
  ...
  func cliValidationCoveragePromotesCredentialedLiveBoundaryArtifacts() throws {
    ...
    expectNoDifference(partialOutput.adaptedCount, 261)
    ...
    expectNoDifference(summaryOnlyOutput.adaptedCount, 261)
    ...
    expectNoDifference(mismatchedEvidenceOutput.adaptedCount, 261)
    ...
    expectNoDifference(malformedCountOutput.adaptedCount, 261)
    ...
    expectNoDifference(fractionalCountOutput.adaptedCount, 261)
    ...
    expectNoDifference(completeOutput.adaptedCount, 262)
