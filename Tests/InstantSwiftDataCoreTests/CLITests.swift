...
extension InstantStoreTests {
  ...
  func cliValidationParityReportEmitsCoverageProvenance() throws {
    ...
    expectNoDifference(jsonOutput.recordCount, 294)
    expectNoDifference(jsonOutput.exactCount, 28)
    expectNoDifference(jsonOutput.adaptedCount, 262)
    ...
    #expect(humanOutput.contains("records: 294"))
    #expect(humanOutput.contains("exact: 28"))
    #expect(humanOutput.contains("adapted: 262"))
  ...
  func cliValidationCoveragePromotesCredentialedLiveBoundaryArtifacts() throws {
    ...
    expectNoDifference(partialOutput.adaptedCount, 263)
    ...
    expectNoDifference(summaryOnlyOutput.adaptedCount, 263)
    ...
    expectNoDifference(mismatchedEvidenceOutput.adaptedCount, 263)
    ...
    expectNoDifference(malformedCountOutput.adaptedCount, 263)
    ...
    expectNoDifference(fractionalCountOutput.adaptedCount, 263)
    ...
    expectNoDifference(completeOutput.adaptedCount, 264)
