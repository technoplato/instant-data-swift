...
extension InstantStoreTests {
  ...
  func cliValidationParityReportEmitsCoverageProvenance() throws {
    ...
    expectNoDifference(jsonOutput.recordCount, 293)
    expectNoDifference(jsonOutput.exactCount, 28)
    expectNoDifference(jsonOutput.adaptedCount, 261)
    ...
    #expect(humanOutput.contains("records: 293"))
    #expect(humanOutput.contains("exact: 28"))
    #expect(humanOutput.contains("adapted: 261"))
  ...
  func cliValidationCoveragePromotesCredentialedLiveBoundaryArtifacts() throws {
    ...
    expectNoDifference(partialOutput.adaptedCount, 262)
    ...
    expectNoDifference(summaryOnlyOutput.adaptedCount, 262)
    ...
    expectNoDifference(mismatchedEvidenceOutput.adaptedCount, 262)
    ...
    expectNoDifference(malformedCountOutput.adaptedCount, 262)
    ...
    expectNoDifference(fractionalCountOutput.adaptedCount, 262)
    ...
    expectNoDifference(completeOutput.adaptedCount, 263)
