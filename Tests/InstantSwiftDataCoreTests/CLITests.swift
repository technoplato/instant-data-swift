...
extension InstantStoreTests {
  ...
  func cliValidationParityReportEmitsCoverageProvenance() throws {
    ...
    expectNoDifference(jsonOutput.recordCount, 287)
    expectNoDifference(jsonOutput.exactCount, 28)
    expectNoDifference(jsonOutput.adaptedCount, 255)
    ...
    #expect(humanOutput.contains("records: 287"))
    #expect(humanOutput.contains("exact: 28"))
    #expect(humanOutput.contains("adapted: 255"))
  ...
  func cliValidationCoveragePromotesCredentialedLiveBoundaryArtifacts() throws {
    ...
    expectNoDifference(partialOutput.adaptedCount, 256)
    ...
    expectNoDifference(summaryOnlyOutput.adaptedCount, 256)
    ...
    expectNoDifference(mismatchedEvidenceOutput.adaptedCount, 256)
    ...
    expectNoDifference(malformedCountOutput.adaptedCount, 256)
    ...
    expectNoDifference(fractionalCountOutput.adaptedCount, 256)
    ...
    expectNoDifference(completeOutput.adaptedCount, 257)
