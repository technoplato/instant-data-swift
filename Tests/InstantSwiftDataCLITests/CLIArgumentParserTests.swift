...
struct CLIArgumentParserTests {
  ...
  func validationRunnerParserParsesFlagsAndAliases() throws {
    ...
    expectNoDifference(
      try parseValidationRunner(["--live-typing-indicator-v3"]),
    ...
    expectNoDifference(
      try parseValidationRunner(["--live-avatar-stack-v3"]),
      .liveAvatarStackV3
    )
    expectNoDifference(
      try parseValidationRunner(["--live-cursors-v3"]),
      .liveCursorsV3
    )
    expectNoDifference(
    ...
    expectNoDifference(
      try parseValidationRunner(["--live-merge-tile-game-v3"]),
      .liveMergeTileGameV3
    )
    expectNoDifference(
    ...
    expectNoDifference(
      try parseValidationRunner(["--live-reminders-v3"]),
      .liveRemindersV3
    )
    expectNoDifference(
    ...
    expectNoDifference(
      CLIValidationRunnerInvocation.liveSharing.caseID,
      "validation.live.sharing"
    )
    expectNoDifference(
      CLIValidationRunnerInvocation.liveSharing.appID,
    ...
    expectNoDifference(
      CLIValidationRunnerInvocation.liveTypingIndicatorV3.caseID,
    ...
    expectNoDifference(
      CLIValidationRunnerInvocation.liveReactionsV3.appID,
      "live-reactions-v3"
    )
    expectNoDifference(
      CLIValidationRunnerInvocation.liveAvatarStackV3.caseID,
      "validation.live.avatar-stack-v3"
    )
    expectNoDifference(
      CLIValidationRunnerInvocation.liveAvatarStackV3.appID,
      "live-avatar-stack-v3"
    )
    expectNoDifference(
      CLIValidationRunnerInvocation.liveCursorsV3.caseID,
      "validation.live.cursors-v3"
    )
    expectNoDifference(
      CLIValidationRunnerInvocation.liveCursorsV3.appID,
      "live-cursors-v3"
    )
    expectNoDifference(
    ...
    expectNoDifference(
      CLIValidationRunnerInvocation.liveMergeTileGameV3.caseID,
      "validation.live.merge-tile-game-v3"
    )
    expectNoDifference(
      CLIValidationRunnerInvocation.liveMergeTileGameV3.appID,
    ...
    expectNoDifference(
      CLIValidationRunnerInvocation.liveRemindersV3.caseID,
      "validation.live.reminders-v3"
    )
    expectNoDifference(
      CLIValidationRunnerInvocation.liveRemindersV3.appID,
      "live-reminders-v3"
    )
    expectNoDifference(
  ...
  func validationRunnerParserReportsMalformedArguments() throws {
    ...
    #expect(CLIValidationRunnerUsage.validationRunner.contains("--live-typing-indicator-v3"))
