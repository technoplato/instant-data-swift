...
# docker-up.sh writes gitignored docker/.env with generated local credentials
# if that file is missing. Compose YAML lists no secret keys; services inherit
# them from that env file.
