...
- `auth.login`: `screens/auth-login.md`
- `recordings.index`: `screens/recordings-list.md`
- `recordings.capture`: `screens/recording.md`
- `recordings.playback`: `screens/playback.md`
- `settings.preferences`: `screens/preferences.md`
