...
public struct SyncUpsV3AppConfiguration: Hashable, Sendable {
  ...
  public static func environment(
    ...
    return Self(
      appID: configuredAppID.flatMap { $0.isEmpty ? nil : $0 } ?? "syncups-v3-local",
  ...
  @MainActor
  public final class SyncUpsV3BootstrapModel: ObservableObject {
    @Published public private(set) var client: InstantSwiftDataClient?
    @Published public private(set) var errorMessage: String?

    public let configuration: SyncUpsV3AppConfiguration
    private var task: Task<Void, Never>?

    public init(configuration: SyncUpsV3AppConfiguration) {
  ...
  @MainActor
  public struct SyncUpsV3BootstrapScreen: View {
    @StateObject private var model: SyncUpsV3BootstrapModel

    public init(model: SyncUpsV3BootstrapModel) {
