...
struct InstantSwiftDataCLI {
  ...
  private static func schemaExample(named rawName: String) throws -> CLISchemaExample {
    ...
    case "streams":
      return CLISchemaExample(
        name: "streams",
        schema: InstantSchemaExamples.streamsDocument,
        permissions: InstantSchemaExamples.streamsPermissions
      )
...
private struct BenchmarkOptions: Sendable {
  ...
  private static var usage: String {
    """
    Usage: instant-swift-data benchmark [--suite <local-todos|cross-sdk-core|cross-sdk-runtime>] [--iterations n] [--app-id id] [--json|--jsonl]
    """
  }
}
