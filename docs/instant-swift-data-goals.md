...
typing-indicator, avatar-stack, cursors, custom-cursors, and merge-tile-game
and Stroopwafel dispatch are combinator-backed, and the executable consumes
those typed leaves produced by the parser instead of reparsing those branches.
...
- run local Swift validation evidence, including
  ...
  typed draft, platform adapter, and SyncUps recording evidence via
