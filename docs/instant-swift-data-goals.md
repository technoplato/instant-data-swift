...
typing-indicator, avatar-stack, and cursors dispatch are combinator-backed, and
the executable consumes those typed leaves produced by the parser instead of
