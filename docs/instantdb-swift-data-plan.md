...
typing-indicator, avatar-stack, cursors, and CloudKitDemo/counters example leaf
dispatch without executable reparsing, init
scaffolding, schema/perms generate/verify, malformed no-bootstrap coverage for
reactions, typing-indicator, avatar-stack, cursors, plus the reminders and sync-ups
