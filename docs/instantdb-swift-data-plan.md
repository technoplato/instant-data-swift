...
typed todos, auth recipe, app-builder, todo-links, and CloudKitDemo/counters
example leaf dispatch without executable reparsing, init scaffolding,
schema/perms generate/verify, the reminders and sync-ups example leaf arguments
