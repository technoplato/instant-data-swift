...
admin query/transact, app show/select/ephemeral, cache inspect/attributes/triples,
connection status/connect/close, local-id get/list,
outbox inspect/transport/flush/confirm/fail/retry/drain,
