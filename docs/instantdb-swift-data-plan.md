...
typed todos, auth recipe, app-builder, and CloudKitDemo/counters example leaf
dispatch without executable reparsing, init scaffolding, schema/perms
generate/verify, the todo-links, reminders, and sync-ups example leaf arguments
