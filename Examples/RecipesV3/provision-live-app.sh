...
# Dotenv for `swift run recipes-v3` (gitignored).
dotenv_file="$script_dir/.env"
printf '# Generated by provision-live-app.sh — do not commit.\n' >"$dotenv_file"
printf 'INSTANT_APP_ID=%s\n' "$app_id" >>"$dotenv_file"
...
print "Dotenv: $dotenv_file"
print "Launch live: set -a; source $dotenv_file; set +a; INSTANT_RECIPE=linked-infinite swift run recipes-v3"
